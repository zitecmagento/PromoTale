...
ypSimpleScroll.prototype.scroll = function(deg, count) {
    ...
    if (d > 0) {
        ...
        if (deg == '270')
            theThumb[count].style.top = parseInt(((theThumb[count].maxY - theThumb[count].minY) * this.scrollTop / this.stopV) + theThumb[count].minY) + "px"; //ok nomes down
        if (deg == '90')
            theThumb[count].style.top = parseInt(((theThumb[count].maxY - theThumb[count].minY) * this.scrollTop / this.scrollH) + theThumb[count].minY) + "px"; //ok nomes down
    }
}
