...
class SOAP_Client extends SOAP_Client_Overload
{
     ...
     *                               a string.
     */
    function SOAP_Client($endpoint, $wsdl = false, $portName = false, $proxy_params = array(), $cache = false)
    {
        ...
        if ($wsdl) {
            ...
            $this->_wsdl = new SOAP_WSDL($this->_endpoint, $this->_proxy_params, $cache);
            if ($this->_wsdl->fault) {
