...
class Zend_Service_WindowsAzure_Storage_Table extends Zend_Service_WindowsAzure_Storage_BatchStorageAbstract
{
        ...
        if ($response->isSuccessful()) {
            ...
            foreach ($entries as $entry) {
                ...
                $returnValue[] = new Zend_Service_WindowsAzure_Storage_TableInstance(
                        (string) $entry->id, $tableName, (string) $entry->link['href'], (string) $entry->updated
                );
            }
    ...
    )
    {
        ...
        return parent::_performRequest(
                        $path, $queryString, $httpVerb, $headers, $forTableStorage, $rawData, $resourceType, $requiredPermission
        );
    }
