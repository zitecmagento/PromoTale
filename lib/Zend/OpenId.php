...
class Zend_OpenId
{
    ...
    static public function digest($func, $data)
    {
        ...
        'Unsupported digest algorithm "' . $func . '".', Zend_OpenId_Exception::UNSUPPORTED_DIGEST);
    }
...
//        return Zend_Crypt_Hmac::compute($secret, $macFunc, $data, Zend_Crypt_Hmac::BINARY);
    ...
    static protected function binToBigNum($bin)
    {
        ...
        #require_once "Zend/OpenId/Exception.php";
        throw new Zend_OpenId_Exception(
        'The system doesn\'t have proper big integer extension', Zend_OpenId_Exception::UNSUPPORTED_LONG_MATH);
    }
    ...
    static protected function bigNumToBin($bn)
    {
        if (extension_loaded('gmp')) {
            ...
            if ($cmp == 0) {
                ...
                #require_once "Zend/OpenId/Exception.php";
                throw new Zend_OpenId_Exception(
                'Big integer arithmetic error', Zend_OpenId_Exception::ERROR_LONG_MATH);
            }
            $bin = "";
            while (bccomp($bn, 0) > 0) {
