...
class Zend_Db_Adapter_Oracle extends Zend_Db_Adapter_Abstract
{
    ...
    protected function _connect()
    {
        ...
        $this->_connection = @$connectionFuncName(
                        $this->_config['username'], $this->_config['password'], $this->_config['dbname'], $this->_config['charset']);
    ...
    {
        return ((bool) (is_resource($this->_connection) && get_resource_type($this->_connection) == 'oci8 connection'));
    }
