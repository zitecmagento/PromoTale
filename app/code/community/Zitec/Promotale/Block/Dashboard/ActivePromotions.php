...
/**
 * PromoTale Dashboard Active Promotions block
 *
 * @category   Zitec
 * @package    Zitec_Promotale
 * @author     Zitec COM <magento@zitec.ro>
 */
class Zitec_Promotale_Block_Dashboard_ActivePromotions extends Mage_Adminhtml_Block_Abstract
{
    ...
    /**
     * Returns the active Catalog Price Rules
     * 
        ...
        if (!$this->_rules) {
            ...
            if ($this->_aggregatedData) {
                ...
                $this->_rules = Mage::getModel('catalogrule/rule')->getCollection()
                        ...
                        ->addFieldToFilter(array('to_date', 'to_date'), array(array('gteq' => $now), array('null' => 'null')))
                        ->addFieldToFilter(array('from_date', 'from_date'), array(array('lteq' => $now), array('null' => 'null')))
    ...
    {
        return isset($this->_aggregatedData[$rule_id]) ? $this->_aggregatedData[$rule_id] : 0;
    }
