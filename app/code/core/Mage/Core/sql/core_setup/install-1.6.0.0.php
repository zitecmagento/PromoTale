...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/website', array('code'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'code'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/website', array('sort_order')), array('sort_order'))
        ->addIndex($installer->getIdxName('core/website', array('default_group_id')), array('default_group_id'))
        ->setComment('Websites');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/store_group', array('website_id')), array('website_id'))
        ->addIndex($installer->getIdxName('core/store_group', array('default_store_id')), array('default_store_id'))
        ->addForeignKey($installer->getFkName('core/store_group', 'website_id', 'core/website', 'website_id'), 'website_id', $installer->getTable('core/website'), 'website_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/store', array('code'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'code'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/store', array('website_id')), array('website_id'))
        ->addIndex($installer->getIdxName('core/store', array('is_active', 'sort_order')), array('is_active', 'sort_order'))
        ->addIndex($installer->getIdxName('core/store', array('group_id')), array('group_id'))
        ->addForeignKey($installer->getFkName('core/store', 'group_id', 'core/store_group', 'group_id'), 'group_id', $installer->getTable('core/store_group'), 'group_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey($installer->getFkName('core/store', 'website_id', 'core/website', 'website_id'), 'website_id', $installer->getTable('core/website'), 'website_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->setComment('Stores');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/config_data', array('scope', 'scope_id', 'path'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'scope', 'scope_id', 'path'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/email_template', array('template_code'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'template_code'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/email_template', array('added_at')), array('added_at'))
        ->addIndex($installer->getIdxName('core/email_template', array('modified_at')), array('modified_at'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/layout_update', array('handle')), array('handle'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/layout_link', array('store_id', 'package', 'theme', 'layout_update_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'store_id', 'package', 'theme', 'layout_update_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/layout_link', array('layout_update_id')), array('layout_update_id'))
        ->addForeignKey($installer->getFkName('core/layout_link', 'store_id', 'core/store', 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey(
                $installer->getFkName('core/layout_link', 'layout_update_id', 'core/layout_update', 'layout_update_id'), 'layout_update_id', $installer->getTable('core/layout_update'), 'layout_update_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/translate', array('store_id', 'locale', 'string'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'store_id', 'locale', 'string'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/translate', array('store_id')), array('store_id'))
        ->addForeignKey($installer->getFkName('core/translate', 'store_id', 'core/store', 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/url_rewrite', array('request_path', 'store_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'request_path', 'store_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/url_rewrite', array('id_path', 'is_system', 'store_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'id_path', 'is_system', 'store_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/url_rewrite', array('target_path', 'store_id')), array('target_path', 'store_id'))
        ->addIndex($installer->getIdxName('core/url_rewrite', array('id_path')), array('id_path'))
        ->addIndex($installer->getIdxName('core/url_rewrite', array('store_id')), array('store_id'))
        ->addForeignKey($installer->getFkName('core/url_rewrite', 'store_id', 'core/store', 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/design_change', array('store_id')), array('store_id'))
        ->addForeignKey($installer->getFkName('core/design_change', 'store_id', 'core/store', 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/variable', array('code'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'code'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/variable_value', array('variable_id', 'store_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'variable_id', 'store_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex($installer->getIdxName('core/variable_value', array('variable_id')), array('variable_id'))
        ->addIndex($installer->getIdxName('core/variable_value', array('store_id')), array('store_id'))
        ->addForeignKey($installer->getFkName('core/variable_value', 'store_id', 'core/store', 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey($installer->getFkName('core/variable_value', 'variable_id', 'core/variable', 'variable_id'), 'variable_id', $installer->getTable('core/variable'), 'variable_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/cache', array('expire_time')), array('expire_time'))
        ->setComment('Caches');
$installer->getConnection()->createTable($table);
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/cache_tag', array('cache_id')), array('cache_id'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('core/flag', array('last_update')), array('last_update'))
        ->setComment('Flag');
$installer->getConnection()->createTable($table);
