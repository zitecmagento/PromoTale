...
$table = $installer->getConnection()
        ...
        ->addIndex(
                $installer->getIdxName($appTableName, array('code'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE), array(
            'code'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
        )
        ->addForeignKey(
                $installer->getFkName($appTableName, 'store_id', $installer->getTable('core/store'), 'store_id'), 'store_id', $installer->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_SET_NULL, Varien_Db_Ddl_Table::ACTION_SET_NULL
        )
...
$configTable = $installer->getConnection()
        ...
        ->addForeignKey(
                $installer->getFkName($configTableName, 'application_id', $appTableName, 'application_id'), 'application_id', $appTableName, 'application_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
...
$historyTable = $installer->getConnection()
        ...
        ->addForeignKey(
                $installer->getFkName($historyTableName, 'application_id', $appTableName, 'application_id'), 'application_id', $appTableName, 'application_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
...
$templateTable = $installer->getConnection()
        ...
        ->addForeignKey(
                $installer->getFkName($templateTableName, 'application_id', $appTableName, 'application_id'), 'application_id', $appTableName, 'application_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
...
$queueTable = $installer->getConnection()
        ...
        ->addForeignKey(
                $installer->getFkName($queueTableName, 'template_id', $templateTableName, 'template_id'), 'template_id', $templateTableName, 'template_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
