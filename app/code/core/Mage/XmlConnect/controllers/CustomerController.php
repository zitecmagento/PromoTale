    ...
    public function storeCreditAction()
    {
        try
        {
            ...
            if (!is_object(Mage::getConfig()->getNode('modules/Enterprise_CustomerBalance'))) {
                $this->_message(
                        $this->__('Customer balance available in enterprise version of Magento only.'), self::MESSAGE_STATUS_ERROR
                );
                return;
            }
            $this->loadLayout(false);
    ...
    public function giftcardCheckAction()
    {
        try
        {
            ...
            if (!is_object(Mage::getConfig()->getNode('modules/Enterprise_GiftCardAccount'))) {
                $this->_message(
                        $this->__('Gift card account available in enterprise version of Magento only.'), self::MESSAGE_STATUS_ERROR
                );
                return;
            }
    ...
    public function giftcardRedeemAction()
    {
        try
        {
            ...
            if ($code) {
                ...
                $this->_message(
                        $this->__('Gift Card "%s" was redeemed.', Mage::helper('core')->escapeHtml($code)), self::MESSAGE_STATUS_SUCCESS
                );
            } else {
                $this->_message($this->__('Gift Card code is empty.'), self::MESSAGE_STATUS_ERROR);
            }
