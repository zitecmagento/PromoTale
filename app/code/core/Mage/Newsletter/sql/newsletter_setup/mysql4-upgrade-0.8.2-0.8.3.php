...
$conn->addColumn($queueTable, 'newsletter_sender_email', "varchar(200) character set latin1 collate latin1_general_ci default NULL AFTER `newsletter_sender_name`");
...
try
{
    $select = $conn->select()
            ...
            ->joinLeft(
            $templateTable, "$templateTable.template_id = main_table.template_id", array(
        'template_type',
        'template_text',
        'template_styles',
        'template_subject',
