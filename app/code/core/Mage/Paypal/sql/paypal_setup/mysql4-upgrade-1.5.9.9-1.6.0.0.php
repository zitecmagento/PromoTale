...
$installer->getConnection()->dropForeignKey(
        $installer->getTable('paypal/cert'), 'FK_PAYPAL_CERT_WEBSITE'
);

$installer->getConnection()->dropForeignKey(
        $installer->getTable('paypal/settlement_report_row'), 'FK_PAYPAL_SETTLEMENT_ROW_REPORT'
);
...
$installer->getConnection()->dropIndex(
        $installer->getTable('paypal/cert'), 'IDX_PAYPAL_CERT_WEBSITE'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('paypal/settlement_report'), 'UNQ_REPORT_DATE_ACCOUNT'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('paypal/settlement_report_row'), 'IDX_REPORT_ID'
);
...
$installer->getConnection()->addIndex(
        $installer->getTable('paypal/cert'), $installer->getIdxName('paypal/cert', array('website_id')), array('website_id')
);

$installer->getConnection()->addIndex(
        $installer->getTable('paypal/settlement_report'), $installer->getIdxName(
                'paypal/settlement_report', array('report_date', 'account_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
        ), array('report_date', 'account_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
);

$installer->getConnection()->addIndex(
        $installer->getTable('paypal/settlement_report_row'), $installer->getIdxName('paypal/settlement_report_row', array(
...
$installer->getConnection()->addForeignKey(
        $installer->getFkName('paypal/settlement_report_row', 'report_id', 'paypal/settlement_report', 'report_id'), $installer->getTable('paypal/settlement_report_row'), 'report_id', $installer->getTable('paypal/settlement_report'), 'report_id'
);

$installer->getConnection()->addForeignKey(
        $installer->getFkName('paypal/cert', 'website_id', 'core/website', 'website_id'), $installer->getTable('paypal/cert'), 'website_id', $installer->getTable('core/website'), 'website_id'
);
