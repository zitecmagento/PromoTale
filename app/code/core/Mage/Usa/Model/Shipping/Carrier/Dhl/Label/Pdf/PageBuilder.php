...
class Mage_Usa_Model_Shipping_Carrier_Dhl_Label_Pdf_PageBuilder
{
    ...
    public function addProductContentCode($code)
    {
        ...
        if ($codes[$code]) {
            $this->_page->drawRectangle(
                    $this->_x(140), $this->_y(0), $this->_x(190), $this->_y(28), Zend_Pdf_Page::SHAPE_DRAW_FILL
            );
    ...
    public function addReceiveInfo(SimpleXMLElement $consignee)
    {
        ...
        $this->_page->drawText($phoneNumber, $this->_x(283), $y, 'UTF-8', Mage_Usa_Model_Shipping_Carrier_Dhl_Label_Pdf_Page::ALIGN_RIGHT
        );
    ...
    public function addDestinationFacilityCode($countryCode, $serviceAreaCode, $facilityCode)
    {
        ...
        $this->_page->drawText($code, $this->_x(144), $this->_y(186), 'UTF-8', Mage_Usa_Model_Shipping_Carrier_Dhl_Label_Pdf_Page::ALIGN_CENTER
        );
    ...
    public function addPieceIdBarcode($dataIdentifier, $licensePlate, $barCode)
    {
        ...
        $this->_page->drawText($routingText, $this->_x(144), $this->_y(563), 'UTF-8', Mage_Usa_Model_Shipping_Carrier_Dhl_Label_Pdf_Page::ALIGN_CENTER
        );
