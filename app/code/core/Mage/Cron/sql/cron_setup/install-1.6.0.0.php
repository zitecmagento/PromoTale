...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('cron/schedule', array('job_code')), array('job_code'))
        ->addIndex($installer->getIdxName('cron/schedule', array('scheduled_at', 'status')), array('scheduled_at', 'status'))
