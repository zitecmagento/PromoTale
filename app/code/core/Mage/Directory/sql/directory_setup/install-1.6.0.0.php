...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('directory/country_region', array('country_id')), array('country_id'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('directory/country_region_name', array('region_id')), array('region_id'))
        ->addForeignKey(
                $installer->getFkName('directory/country_region_name', 'region_id', 'directory/country_region', 'region_id'), 'region_id', $installer->getTable('directory/country_region'), 'region_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('directory/currency_rate', array('currency_to')), array('currency_to'))
