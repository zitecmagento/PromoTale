...
$table = $adapter->newTable($installer->getTable('oauth/consumer'))
        ...
        ->addIndex(
                $installer->getIdxName(
                        $installer->getTable('oauth/consumer'), array('key'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                ), array('key'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addIndex(
                $installer->getIdxName(
                        $installer->getTable('oauth/consumer'), array('secret'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
...
$table = $adapter->newTable($installer->getTable('oauth/token'))
        ...
        ->addIndex(
                $installer->getIdxName(
                        $installer->getTable('oauth/token'), array('consumer_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_INDEX
                ), array('consumer_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_INDEX))
        ->addIndex(
                $installer->getIdxName(
                        $installer->getTable('oauth/token'), array('token'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                ), array('token'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
        ->addForeignKey(
                $installer->getFkName('oauth/token', 'admin_id', $installer->getTable('admin/user'), 'user_id'), 'admin_id', $installer->getTable('admin/user'), 'user_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey(
                $installer->getFkName('oauth/token', 'consumer_id', 'oauth/consumer', 'entity_id'), 'consumer_id', $installer->getTable('oauth/consumer'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
        ->addForeignKey(
                $installer->getFkName('oauth/token', 'customer_id', $installer->getTable('customer/entity'), 'entity_id'), 'customer_id', $installer->getTable('customer/entity'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $adapter->newTable($installer->getTable('oauth/nonce'))
        ...
        ->addIndex(
                $installer->getIdxName(
                        $installer->getTable('oauth/nonce'), array('nonce'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                ), array('nonce'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
