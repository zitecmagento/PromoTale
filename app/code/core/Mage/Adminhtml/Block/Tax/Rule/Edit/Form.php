...
class Mage_Adminhtml_Block_Tax_Rule_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('tax_customer_class', 'multiselect', array(
        ...
        $fieldset->addField('tax_product_class', 'multiselect', array(
        ...
        $fieldset->addField('tax_rate', 'multiselect', array(
            'name' => 'tax_rate',
        ...
        $fieldset->addField('calculate_subtotal', 'checkbox', array(
        ...
        if ($model->getId() > 0) {
            $fieldset->addField('tax_calculation_rule_id', 'hidden', array(
