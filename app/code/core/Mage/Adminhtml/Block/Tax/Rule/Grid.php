...
class Mage_Adminhtml_Block_Tax_Rule_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('customer_tax_classes', array(
        ...
        $this->addColumn('product_tax_classes', array(
        ...
        $this->addColumn('tax_rates', array(
            'sortable' => false,
        ...
        $this->addColumn('calculate_subtotal', array(
