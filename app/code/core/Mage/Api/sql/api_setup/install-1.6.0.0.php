...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('api/role', array('parent_id', 'sort_order')), array('parent_id', 'sort_order'))
        ->addIndex($installer->getIdxName('api/role', array('tree_level')), array('tree_level'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('api/rule', array('resource_id', 'role_id')), array('resource_id', 'role_id'))
        ->addIndex($installer->getIdxName('api/rule', array('role_id', 'resource_id')), array('role_id', 'resource_id'))
        ->addForeignKey($installer->getFkName('api/rule', 'role_id', 'api/role', 'role_id'), 'role_id', $installer->getTable('api/role'), 'role_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('api/session', array('user_id')), array('user_id'))
        ->addIndex($installer->getIdxName('api/session', array('sessid')), array('sessid'))
        ->addForeignKey($installer->getFkName('api/session', 'user_id', 'api/user', 'user_id'), 'user_id', $installer->getTable('api/user'), 'user_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
