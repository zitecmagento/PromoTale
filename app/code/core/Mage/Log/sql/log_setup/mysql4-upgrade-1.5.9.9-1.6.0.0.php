...
$installer->getConnection()->dropIndex(
        $installer->getTable('log/customer'), 'IDX_VISITOR'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('log_visitor_online'), 'IDX_VISITOR_TYPE'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('log_visitor_online'), 'IDX_VISIT_TIME'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('log_visitor_online'), 'IDX_CUSTOMER'
);

$installer->getConnection()->dropIndex(
        $installer->getTable('log_url'), 'IDX_VISITOR'
);
...
$installer->getConnection()->addIndex(
        $installer->getTable('log/customer'), $installer->getIdxName('log/customer', array('visitor_id')), array('visitor_id')
);

$installer->getConnection()->addIndex(
        $installer->getTable('log/url_table'), $installer->getIdxName('log/url_table', array('visitor_id')), array('visitor_id')
);

$installer->getConnection()->addIndex(
        $installer->getTable('log/visitor_online'), $installer->getIdxName('log/visitor_online', array('visitor_type')), array(
    'visitor_type')
);

$installer->getConnection()->addIndex(
        $installer->getTable('log/visitor_online'), $installer->getIdxName('log/visitor_online', array('first_visit_at',
            'last_visit_at')), array('first_visit_at', 'last_visit_at')
);

$installer->getConnection()->addIndex(
        $installer->getTable('log/visitor_online'), $installer->getIdxName('log/visitor_online', array('customer_id')), array(
    'customer_id')
);
