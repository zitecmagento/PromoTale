...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('log/customer', array('visitor_id')), array('visitor_id'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('log/url_table', array('visitor_id')), array('visitor_id'))
...
$table = $installer->getConnection()
        ...
        ->addIndex($installer->getIdxName('log/visitor_online', array('visitor_type')), array('visitor_type'))
        ->addIndex($installer->getIdxName('log/visitor_online', array('first_visit_at', 'last_visit_at')), array('first_visit_at',
            'last_visit_at'))
        ->addIndex($installer->getIdxName('log/visitor_online', array('customer_id')), array('customer_id'))
